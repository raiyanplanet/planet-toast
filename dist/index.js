...
const ToastItem = ({ toast: toastData, offset, reverseOrder, }) => {
    ...
    return (jsxRuntime.jsx("div", { style: {
            ...
            willChange: "transform, opacity",
                ...
                ...typeStyles,
            }, onClick: handleDismiss, children: [jsxRuntime.jsx(ToastIcon, { type: toastData.type }), jsxRuntime.jsx("div", { style: { flex: 1, wordBreak: "break-word", lineHeight: "1.5" }, children: toastData.message }), jsxRuntime.jsx("button", { style: {
                        background: "none",
                        border: "none",
                        cursor: "pointer",
                        opacity: 0.5,
