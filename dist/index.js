...
const useToasts = () => {
    return react.useSyncExternalStore(toastStore.subscribe.bind(toastStore), toastStore.getSnapshot.bind(toastStore));
};
...
const ToastIcon = ({ type }) => {
    ...
    switch (type) {
        case "success":
            return (jsxRuntime.jsx("div", { style: { ...baseStyle, backgroundColor: "#10b981", color: "white" }, children: "\u2713" }));
        case "error":
            return (jsxRuntime.jsx("div", { style: { ...baseStyle, backgroundColor: "#ef4444", color: "white" }, children: "\u2715" }));
        case "loading":
        ...
        default:
            return (jsxRuntime.jsx("div", { style: { ...baseStyle, backgroundColor: "#6b7280", color: "white" }, children: "\u2139" }));
    }
};
...
const ToastItem = ({ toast: toastData, offset, reverseOrder, }) => {
    ...
    return (jsxRuntime.jsx("div", { style: {
            ...
            pointerEvents: toastData.visible ? "auto" : "none",
                ...
                cursor: "pointer",
                ...typeStyles,
            }, onClick: handleDismiss, children: [jsxRuntime.jsx(ToastIcon, { type: toastData.type }), jsxRuntime.jsx("div", { style: { flex: 1, wordBreak: "break-word" }, children: toastData.message }), jsxRuntime.jsx("button", { style: {
                        background: "none",
                        border: "none",
                        cursor: "pointer",
                        opacity: 0.5,
...
const Toaster = ({ position = "top-center", reverseOrder = false, gutter = 8, containerStyle, toastOptions, }) => {
    ...
    const orderedToasts = reverseOrder
        ...
        : visibleToasts;
    return (jsxRuntime.jsx("div", { style: { ...getPositionStyles(), ...containerStyle }, children: orderedToasts.map((toast, index) => (jsxRuntime.jsx(ToastItem, { toast: toast, offset: index * (60 + gutter), reverseOrder: reverseOrder }, toast.id))) }));
};
